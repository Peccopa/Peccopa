...
- _SASS, BEM, PHPMailer, Figma(Pixso), Animate.css, Wow.js_
...
- **_jQuery:_** _SlickSlider, phpMyAdmin_
...
- _Sass, BootstrapGrid_
- _Figma(Pixso), FontAwesomeIcons, ~~PerfectPixel~~_
